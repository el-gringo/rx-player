...
export type IManifestParserRequestScheduler =
  (
    ...
    canceller : TaskCanceller
  ) =>  Promise< IRequestedData< Document | ILoadedManifestFormat > >;
...
export interface ISegmentLoaderCallbacks<T> {
   ...
   *
   * In both of those cases, the segment data can be retrieved in the Promise
   * returned by the segment loader.
   */
